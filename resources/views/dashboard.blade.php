 ...
 @if(session('success'))
  <div class="flex justify-end max-w-7xl">
    <div 
        ...
        x-show="show"
        class="bg-green-100 p-2 rounded mb-4 max-w-6xl"
    >
        {{ session('success') }}
    </div>
</div>
        ...
        <table class="table-auto w-full border border-gray-300">
            ...
            <tbody>
                ...
                <tr 
                    ...
                    x-show="{{ json_encode($company->name) }}.toLowerCase().includes(search.toLowerCase()) || 
                    {{ json_encode($company->industry) }}.toLowerCase().includes(search.toLowerCase()) || 
                    {{ json_encode($company->address) }}.toLowerCase().includes(search.toLowerCase())"
                    >
